  ...
  <section class="content">
     ...
     <!--  <th> 	  Delete</th> -->
      ...
      <TR>
       ...
       <td><a href="displayImageEmp.jsp?id=<%= rs.getInt(1) %>">View</a></td>
       <td><a href="EmpEditProj.jsp?id=<%= rs.getInt(1) %><%int pid = rs.getInt(1);
      com.cred.Credentials.setPid(pid);%>">view</a></td>
