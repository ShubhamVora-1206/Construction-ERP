  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Emp\Dept</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="viewReport.jsp" class="nav-link">
              <i class="nav-icon fas fa-th"></i>
              <p>
                View Reports
                <span class="right badge badge-danger"></span>
  ...
  <section class="content">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              PreparedStatement pstmt = con.prepareStatement("select * from report") ;
     ...
     <!--  <th> 	  Delete</th> -->
      ...
      <TR>
       ...
       <TD> <%= rs.getInt(12) %></TD>
       <td><a href="displayImage.jsp?id=<%= rs.getInt(1) %>">view Image</a></td>
      <%--  <TD> <a href="EmpDeleteProj.jsp?id=<%= rs.getInt(1) %>">delete</a></TD> --%>
      </TR>
      <% } 
          %>
     </TABLE>
